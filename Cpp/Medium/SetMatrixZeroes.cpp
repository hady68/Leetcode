...
// OPTIMAL -> You can use the first row as the column of the matrix and first column as the row of the matrix.
//Then take a variable to use it as a flag to where to mark a zero and where not to.
//Then traverse the matrix from the back and start marking zeros.
